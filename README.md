...
> ### **WDS MCP 플러그인 설치 필수**
>
> 이 스킬은 **WDS MCP 플러그인이 설치되어 있어야** 정상 동작합니다.
> WDS MCP 없이는 컴포넌트, 토큰, 패턴 정보를 조회할 수 없어 리뷰가 잘 동작하지 않을 수도 있습니다. 
>
...
### Step 3. WDS MCP 플러그인 설치 확인

스킬 사용 전, 상단의 **WDS MCP 플러그인 설치 필수** 안내를 확인하고 설치를 완료해주세요.
